# 📊 Layoff Analysis (COVID & Post-COVID)

## Overview
This project examines global layoff patterns during the COVID-19 pandemic (2020–2021) and the post-COVID period (2022–2023).
The analysis highlights how different industries were affected, compares the scale of layoffs across sectors, and uncovers shifts in employment trends before and after the pandemic.

## 🔧 Tools & Techniques
- **SQL** → Data cleaning & exploratory data analysis (EDA)  
- **Excel** → Visualization & trend analysis  

## 📂 About Dataset 
*(Dataset includes company details, industry, layoffs, funding, and stage information.)*
...
## 📊 Visualizations
- Layoff trends by industry (COVID vs Post-COVID)  
- Country-wise layoff distribution  
- Funding stage vs layoffs correlation  
